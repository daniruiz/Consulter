...
public class ControlPaciente extends Control {
	...
	public void iniciarActualizar() {
		...
		try {
			...
			String query = "update Pacientes set NOMBRE = ?, APELLIDO= ?, COMPANIA_SEGUROS= ?,  DNI= ? WHERE IDPACIENTE= ?";
	...
	public void cargarDatos() {
		...
		try {
			...
			String query = "select (NOMBRE, APELLIDO, COMPANIA_SEGUROS, DNI, IDMEDICO from Pacientes where IDPACIENTE = ?";
			...
			{ 
				...
				paciente.setCompaniaSeguros(rs.getString("NUM_COMPANIERO"));
